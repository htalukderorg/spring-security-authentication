 ...
 * AuthenticationCredentialsNotFoundException; import
 ...
 * 
 * 
 * AuthenticationProvider implements the authentication logic. It receives the
 * request from the AuthenticationManager and delegates finding the user to a
 * UserDetails-Service, and verifying the password to a PasswordEncoder. You can
 ...
 * 
 * if ("abhik".equals(username) && "jaysen".equals(password)) { return new
 ...
 * 
 * @Override public boolean supports(Class<?> authenticationType) { return
